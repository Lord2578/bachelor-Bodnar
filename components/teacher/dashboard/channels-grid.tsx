...
export function ChannelsGrid({ channels }: ChannelsGridProps) {
  return (
    <div className="flex flex-col space-y-4 bg-white rounded-lg p-4 shadow-sm h-full">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-medium">Recent channels</h2>
        <Button variant="link" className="text-sm text-blue-500 shrink-0">
          View all
        </Button>
      </div>
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 overflow-auto flex-1">
